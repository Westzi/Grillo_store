const product = {
    ...
    price: 163.83,
    oldPrice: 0.00,
    // ⭐️ CORREÇÃO 1: ADICIONAR O SLUG COMPLETO
...
// =====================================================
// FUNÇÕES DE EXIBIÇÃO DO PRODUTO 
// =====================================================
...
function goToCheckout() {
    // Redireciona para checkout com o slug do produto
...
// =====================================================
// INICIALIZAÇÃO DE EVENTOS (COM LÓGICA DE CLONAGEM)
// =====================================================
document.addEventListener('DOMContentLoaded', () => {
    ...
    // ⭐️ CORREÇÃO ESSENCIAL: Lógica de Checkout / Compra Rápida (Igual à página funcional)
    const buyNowButton = document.querySelector('.buy-now-button');
    if (buyNowButton) {
        // Remove listeners antigos (se existirem) e prepara para o novo
        ...
        newBuyNowButton.addEventListener('click', function(e) {
            e.preventDefault();
            goToCheckout(); // Usa a função com o slug
        });
    }

    // Lógica do botão "Adicionar ao Carrinho" (Mantida a sua lógica original)
    const addToCartButton = document.getElementById('add-to-cart-button');
    if (addToCartButton) {
        addToCartButton.addEventListener('click', () => {
             // Esta parte deve ser substituída por AJAX para ser funcional
    ...
    // Flyout carrinho (Lógica de abrir/fechar)
    ...
    // Dark Mode (Mantida a sua lógica original)
