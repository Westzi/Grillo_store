const product = {
    id: 2,
    name: "Kit 4 Camisetas Femininas Academia - Atacado (Cores Sortidas)",
    price: 99.90, 
    oldPrice: 120.00, 
    installments: { 
        count: 5, 
    ...
    color: "Cores Sortidas",
    images: [
        "../imagens-produtos/camisa1fem.jpg", 
        "../imagens-produtos/camisa2fem.jpg", 
        "../imagens-produtos/camisa3fem.jpg", 
        "../imagens-produtos/camisa4fem.jpg",
        "../imagens-produtos/camisa5fem.jpg" 
    ],
    specs: [
        "Material: Poliéster e Elastano (Tecido Dry Fit).",
        "Tamanhos disponíveis: P, M, G, GG.",
        "Ideal para academia, caminhada e uso casual.",
        "Secagem rápida e toque suave.",
        "Observação: As cores são enviadas sortidas conforme disponibilidade de estoque."
    ],
    seller: "AtacadoFitness"
};
