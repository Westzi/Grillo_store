const product = {
    ...
    specs: [
        "Processador: Intel Core i5-13420H de 13ª Geração",
        "Memória RAM: 8GB DDR4 (expansível)",
        "Armazenamento: 512GB SSD NVMe de alta velocidade",
        "Tela: 15.6 polegadas, Full HD (1920x1080)",
        "Sistema Operacional: Windows 11 Home",
        "Ideal para estudos, trabalho e uso diário com bom desempenho."
    ],
    seller: "Acer"
};
